...
`GET 202 https://api.notzerotwo.ml/data/serverbanner?api=Apikey&ip=mc.hypixel.net&name=Hypixel Network` 
`GET 202 https://api.notzerotwo.ml/data/websitetoapi?api=Apikey&link=https://notzerotwo.ml`   
